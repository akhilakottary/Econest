          ...
          return (
            <div key={plant.id} className="card">
              ...
              <div className="qtyRow">
                ...
                {/* <span className="qty">
                  {cartItems.find((item) => item.id === plant.id)?.quantity || 0}
                </span> */}
                {/* <button
                  className="pill"
                  onClick={() =>
                  ...
                  disabled={!isInCart || cartItems.find((item) => item.id === plant.id)?.quantity === 1}
                >
                  -
                </button> */}
              </div>
